...
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/lloadout/microsoftgraph/fix-php-code-style-issues.yml?branch=main&label=code%20style&style=flat-square)](https://github.com/lloadout/microsoftgraph/actions?query=workflow%3A"Fix+PHP+code+style+issues"+branch%3Amain)
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/microsoftgraph.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/microsoftgraph)
...
```bash
php artisan vendor:publish --tag="microsoftgraph-views"
```

## Usage

```php
$microsoftgraph = new LLoadout\Microsoftgraph();
echo $microsoftgraph->echoPhrase('Hello, LLoadout!');
```
